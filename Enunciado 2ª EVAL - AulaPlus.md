...
* Crear un tema propio basado en Material Design. esto se hace siguiento estos pasos, primero se crea un nuevo tema en el archivo themes.xml, luego se personaliza el tema con los colores y estilos que se deseen, asegurándose de que el nuevo icono se integre bien con el diseño general.
